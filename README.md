...
🔷 PROBLEM STATEMENT: CUSTOMER SHOPPING BEHAVIOR ANALYSIS

In today’s competitive retail environment, understanding customer purchasing patterns is essential for improving revenue, enhancing customer satisfaction, and enabling data-driven decision-making. The objective of this project is to analyze customer shopping behavior to uncover insights related to sales trends, revenue distribution, subscription impact, age-group purchasing patterns, and product category performance.
...
Item_Purchased: Product purchased by the customer.
Category: Product category (Clothing, Accessories, Footwear, Outerwear).
Purchase_Amount_USD: Amount spent on the purchase in USD.
Review_Rating: Customer rating given to the product.
...
Average review rating analysis
...
Sales and Revenue Category Breakdown

Age Group Revenue Distribution

Interactive Filters (Gender, Subscription Status, Category)
...
By identifying key customer segments and high-performing product categories, businesses can optimize marketing strategies, improve inventory planning, enhance customer engagement, and increase profitability. This project demonstrates the practical application of SQL, Python, and Power BI in solving real-world business analytics problems.
